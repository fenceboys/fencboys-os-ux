...
export const initialProjectStatusConfigs: ProjectStatusConfig[] = [
  // Schedule Phase
  { id: 'status1', name: 'New Lead', customerLabel: 'Preparing Your Quote', phase: 'schedule', triggerNote: 'New lead created', sortOrder: 1, bgColor: '#dbeafe', textColor: '#1d4ed8', isActive: true, notifications: { slack: { enabled: true, channel: '#fb-sales' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'status2', name: 'Quote Scheduled', customerLabel: 'Preparing Your Quote', phase: 'schedule', triggerNote: 'Quote appointment booked', sortOrder: 2, bgColor: '#dbeafe', textColor: '#1d4ed8', isActive: true, notifications: { slack: { enabled: true, channel: '#fb-sales' }, sms: { enabled: true, template: 'Hi {{customer_name}}, your quote appointment is confirmed!' }, email: { enabled: false, subject: '', body: '' } } },
  // Proposal Phase
  { id: 'status3', name: 'Building Proposal', customerLabel: 'Preparing Your Quote', phase: 'proposal', triggerNote: 'Salesperson building proposal', sortOrder: 3, bgColor: '#fef3c7', textColor: '#92400e', isActive: true, notifications: { slack: { enabled: false, channel: '' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'status4', name: 'Proposal Sent', customerLabel: 'Reviewing & Signing', phase: 'proposal', triggerNote: 'Proposal sent to customer', sortOrder: 4, bgColor: '#fef3c7', textColor: '#92400e', isActive: true, notifications: { slack: { enabled: true, channel: '#fb-sales' }, sms: { enabled: true, template: 'Hi {{customer_name}}, your proposal is ready to review!' }, email: { enabled: true, subject: 'Your Fence Boys Proposal', body: 'Hi {{customer_name}},\n\nYour proposal is ready for review.' } } },
  { id: 'status5', name: 'Awaiting Deposit', customerLabel: 'Reviewing & Signing', phase: 'proposal', triggerNote: 'Waiting for customer deposit', sortOrder: 5, bgColor: '#fef3c7', textColor: '#92400e', isActive: true, notifications: { slack: { enabled: false, channel: '' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'status6', name: 'Lost', customerLabel: 'Closed', phase: 'proposal', triggerNote: 'Deal lost', sortOrder: 6, bgColor: '#fee2e2', textColor: '#991b1b', isActive: true, notifications: { slack: { enabled: true, channel: '#fb-sales' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'status7', name: 'Quote Expired', customerLabel: 'Quote Expired', phase: 'proposal', triggerNote: 'Quote past expiration', sortOrder: 7, bgColor: '#f3f4f6', textColor: '#374151', isActive: true, notifications: { slack: { enabled: false, channel: '' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  // Permits Phase
  { id: 'status8', name: 'Permit Preparation', customerLabel: 'Processing Permits', phase: 'permits', triggerNote: 'Preparing permit application', sortOrder: 8, bgColor: '#e0e7ff', textColor: '#3730a3', isActive: true, notifications: { slack: { enabled: true, channel: '#fb-ops' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'status9', name: 'Customer Docs Needed', customerLabel: 'Processing Permits', phase: 'permits', triggerNote: 'Waiting on customer documents', sortOrder: 9, bgColor: '#e0e7ff', textColor: '#3730a3', isActive: true, notifications: { slack: { enabled: false, channel: '' }, sms: { enabled: true, template: 'Hi {{customer_name}}, we need some documents from you to proceed.' }, email: { enabled: true, subject: 'Documents Needed', body: 'Hi {{customer_name}},\n\nWe need some documents to proceed with your permit.' } } },
  { id: 'status10', name: 'Permit Submitted', customerLabel: 'Processing Permits', phase: 'permits', triggerNote: 'Permit submitted to city', sortOrder: 10, bgColor: '#e0e7ff', textColor: '#3730a3', isActive: true, notifications: { slack: { enabled: true, channel: '#fb-ops' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'status11', name: 'Permit Revision Needed', customerLabel: 'Processing Permits', phase: 'permits', triggerNote: 'City requested changes', sortOrder: 11, bgColor: '#e0e7ff', textColor: '#3730a3', isActive: true, notifications: { slack: { enabled: true, channel: '#fb-ops' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'status12', name: 'Permit Resubmitted', customerLabel: 'Processing Permits', phase: 'permits', triggerNote: 'Revised permit resubmitted', sortOrder: 12, bgColor: '#e0e7ff', textColor: '#3730a3', isActive: true, notifications: { slack: { enabled: false, channel: '' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  // Materials Phase
  { id: 'status13', name: 'Ready to Order Materials', customerLabel: 'Scheduling Your Installation', phase: 'materials', triggerNote: 'Permit approved, ready to order', sortOrder: 13, bgColor: '#d1fae5', textColor: '#065f46', isActive: true, notifications: { slack: { enabled: true, channel: '#fb-ops' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'status14', name: 'Materials Ordered', customerLabel: 'Scheduling Your Installation', phase: 'materials', triggerNote: 'Materials on order', sortOrder: 14, bgColor: '#d1fae5', textColor: '#065f46', isActive: true, notifications: { slack: { enabled: false, channel: '' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  // Scheduling Phase
  { id: 'status15', name: 'Scheduling Installation', customerLabel: 'Scheduling Your Installation', phase: 'scheduling', triggerNote: 'Coordinating install date', sortOrder: 15, bgColor: '#fce7f3', textColor: '#9d174d', isActive: true, notifications: { slack: { enabled: false, channel: '' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'status16', name: 'Installation Scheduled', customerLabel: 'Scheduling Your Installation', phase: 'scheduling', triggerNote: 'Install date confirmed', sortOrder: 16, bgColor: '#fce7f3', textColor: '#9d174d', isActive: true, notifications: { slack: { enabled: true, channel: '#fb-ops' }, sms: { enabled: true, template: 'Hi {{customer_name}}, your installation is scheduled!' }, email: { enabled: true, subject: 'Installation Scheduled', body: 'Hi {{customer_name}},\n\nYour fence installation has been scheduled.' } } },
  { id: 'status17', name: 'Installation Delayed', customerLabel: 'Installation in Progress', phase: 'scheduling', triggerNote: 'Install postponed', sortOrder: 17, bgColor: '#fce7f3', textColor: '#9d174d', isActive: true, notifications: { slack: { enabled: true, channel: '#fb-ops' }, sms: { enabled: true, template: 'Hi {{customer_name}}, we need to reschedule your installation.' }, email: { enabled: false, subject: '', body: '' } } },
  // Installation Phase
  { id: 'status18', name: 'Installation in Progress', customerLabel: 'Installation in Progress', phase: 'installation', triggerNote: 'Crew on site', sortOrder: 18, bgColor: '#fed7aa', textColor: '#9a3412', isActive: true, notifications: { slack: { enabled: true, channel: '#fb-ops' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'status19', name: 'Scheduling Walkthrough', customerLabel: 'Installation in Progress', phase: 'installation', triggerNote: 'Install complete, scheduling walkthrough', sortOrder: 19, bgColor: '#fed7aa', textColor: '#9a3412', isActive: true, notifications: { slack: { enabled: false, channel: '' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'status20', name: 'Walkthrough Scheduled', customerLabel: 'Installation in Progress', phase: 'installation', triggerNote: 'Walkthrough date set', sortOrder: 20, bgColor: '#fed7aa', textColor: '#9a3412', isActive: true, notifications: { slack: { enabled: false, channel: '' }, sms: { enabled: true, template: 'Hi {{customer_name}}, your walkthrough is scheduled!' }, email: { enabled: false, subject: '', body: '' } } },
  // Close Out Phase
  { id: 'status21', name: 'Fixes Needed', customerLabel: 'Installation in Progress', phase: 'close_out', triggerNote: 'Punch list items identified', sortOrder: 21, bgColor: '#fef3c7', textColor: '#92400e', isActive: true, notifications: { slack: { enabled: true, channel: '#fb-ops' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'status22', name: 'Final Payment Due', customerLabel: 'Final Payment', phase: 'close_out', triggerNote: 'Ready for final payment', sortOrder: 22, bgColor: '#d1fae5', textColor: '#065f46', isActive: true, notifications: { slack: { enabled: false, channel: '' }, sms: { enabled: true, template: 'Hi {{customer_name}}, your fence is complete! Final payment is now due.' }, email: { enabled: true, subject: 'Final Payment Due', body: 'Hi {{customer_name}},\n\nYour fence installation is complete. Please submit your final payment.' } } },
  { id: 'status23', name: 'Requesting Review', customerLabel: 'Complete', phase: 'close_out', triggerNote: 'Asking for Google review', sortOrder: 23, bgColor: '#d1fae5', textColor: '#065f46', isActive: true, notifications: { slack: { enabled: false, channel: '' }, sms: { enabled: true, template: 'Hi {{customer_name}}, thank you for choosing Fence Boys! Would you mind leaving us a review?' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'status24', name: 'Complete', customerLabel: 'Complete', phase: 'close_out', triggerNote: 'Project fully complete', sortOrder: 24, bgColor: '#d1fae5', textColor: '#065f46', isActive: true, notifications: { slack: { enabled: true, channel: '#fb-sales' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
];
...
export const initialCustomerStatusConfigs: CustomerStatusConfig[] = [
  { id: 'cstat1', name: 'Lead', sortOrder: 1, isActive: true },
  { id: 'cstat2', name: 'Unqualified Lead', sortOrder: 2, isActive: true },
  { id: 'cstat3', name: 'Active', sortOrder: 3, isActive: true },
  { id: 'cstat4', name: 'Complete', sortOrder: 4, isActive: true },
];
