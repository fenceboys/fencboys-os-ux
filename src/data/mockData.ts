...
export const initialCustomers: Customer[] = [
  ...
  // 10b. Quote Expired - Another
  {
    id: 'cust9b',
    name: 'Michael Sanchez',
    phone: '(614) 555-0150',
    email: 'msanchez@gmail.com',
    address: '2890 Cleveland Ave',
    city: 'Columbus',
    state: 'OH',
    zip: '43224',
    requestType: 'replace',
    ...
    tags: ['6ft Cedar Privacy'],
    salespersonId: 'sp1',
    notes: 'Was comparing prices with other companies',
    createdAt: '2026-03-20T10:00:00Z',
  },
  // Needs Qualifying - New web leads
  {
    id: 'cust_nq1',
    name: 'Patricia Green',
    phone: '(614) 555-0160',
    email: 'pgreen@yahoo.com',
    address: '1590 Parsons Ave',
    city: 'Columbus',
    state: 'OH',
    zip: '43207',
    requestType: 'build',
    preferredContact: 'phone',
    status: 'needs_qualifying',
    tags: [],
    salespersonId: 'sp1',
    notes: 'Submitted via website - needs callback',
  ...
  },
  {
    ...
    name: 'James Wilson',
    phone: '(614) 555-0161',
    email: 'jwilson.cbus@gmail.com',
    address: '4521 Karl Rd',
    city: 'Columbus',
    state: 'OH',
    zip: '43224',
    requestType: 'repair',
    ...
    tags: [],
    salespersonId: 'sp2',
    notes: 'Fence damaged in storm - urgent',
  ...
  },
  {
    ...
    name: 'Amanda Davis',
    phone: '(614) 555-0162',
    email: 'adavis@outlook.com',
    address: '789 Livingston Ave',
    city: 'Columbus',
    state: 'OH',
    zip: '43205',
    requestType: 'build',
    ...
    tags: [],
    salespersonId: 'sp3',
    notes: 'Google lead - interested in pool fence',
...
export const initialProjects: Project[] = [
  ...
  // 1. New Lead
  { id: 'proj1', customerId: 'cust1', name: 'Rivera Fence', address: '3421 Sullivant Ave, Columbus, OH 43204', status: 'not_started', customerStatus: 'New Lead', salespersonId: 'sp1', portalLive: false, autoNotifications: true, buildType: 'new_build', leadSource: 'webflow_form', statusChangedAt: '2026-03-28T10:00:00Z', lastContacted: '2026-03-28T10:00:00Z', createdAt: '2026-03-28T10:00:00Z' },
  // 2-4. Quote Scheduled (multiple)
  { id: 'proj2', customerId: 'cust2', name: 'Mitchell Fence', address: '1847 Bryden Rd, Columbus, OH 43205', status: 'not_started', customerStatus: 'Quote Scheduled', salespersonId: 'sp1', portalLive: true, autoNotifications: true, salesAppointment: '2026-03-31T10:00:00Z', buildType: 'replacement', leadSource: 'phone', statusChangedAt: '2026-03-25T10:00:00Z', lastContacted: '2026-03-29T14:00:00Z', createdAt: '2026-03-24T10:00:00Z' },
  { id: 'proj3', customerId: 'cust3', name: 'Chen Fence', address: '5590 Riverside Dr, Columbus, OH 43221', status: 'not_started', customerStatus: 'Quote Scheduled', salespersonId: 'sp2', portalLive: true, autoNotifications: true, salesAppointment: '2026-03-31T14:00:00Z', buildType: 'new_build', leadSource: 'google_lsa', statusChangedAt: '2026-03-24T10:00:00Z', lastContacted: '2026-03-28T09:00:00Z', createdAt: '2026-03-23T10:00:00Z' },
  { id: 'proj4', customerId: 'cust4', name: 'Lopez Fence', address: '892 Oakland Park Ave, Columbus, OH 43224', status: 'not_started', customerStatus: 'Quote Scheduled', salespersonId: 'sp3', portalLive: true, autoNotifications: true, salesAppointment: '2026-03-31T16:00:00Z', buildType: 'new_build', leadSource: 'meta_ads', statusChangedAt: '2026-03-23T10:00:00Z', lastContacted: '2026-03-27T11:00:00Z', createdAt: '2026-03-22T10:00:00Z' },
  // 5. Building Proposal
  { id: 'proj5', customerId: 'cust5', name: 'Howard Fence', address: '2234 Fairwood Ave, Columbus, OH 43207', status: 'not_started', customerStatus: 'Building Proposal', salespersonId: 'sp1', portalLive: true, autoNotifications: true, salesAppointment: '2026-03-18T10:00:00Z', buildType: 'replacement', leadSource: 'referral', statusChangedAt: '2026-03-18T16:00:00Z', lastContacted: '2026-03-26T10:00:00Z', createdAt: '2026-03-15T10:00:00Z' },
  // 6. Proposal Sent
  { id: 'proj6', customerId: 'cust6', name: 'Washington Fence', address: '789 S Champion Ave, Columbus, OH 43206', status: 'not_started', customerStatus: 'Proposal Sent', salespersonId: 'sp1', portalLive: true, autoNotifications: true, salesAppointment: '2026-03-11T14:00:00Z', buildType: 'new_build', leadSource: 'email', statusChangedAt: '2026-03-12T10:00:00Z', lastContacted: '2026-03-25T15:00:00Z', createdAt: '2026-03-10T10:00:00Z' },
  // 7. Awaiting Deposit
  { id: 'proj7', customerId: 'cust7', name: 'Patel Fence', address: '4412 Kenny Rd, Columbus, OH 43220', status: 'not_started', customerStatus: 'Awaiting Deposit', salespersonId: 'sp2', portalLive: true, autoNotifications: true, salesAppointment: '2026-03-06T11:00:00Z', depositAmount: 2400, buildType: 'new_build', leadSource: 'text', statusChangedAt: '2026-03-08T14:00:00Z', lastContacted: '2026-03-24T09:00:00Z', createdAt: '2026-03-05T10:00:00Z' },
  // 8. Lost
  { id: 'proj8', customerId: 'cust8', name: 'Foster Fence', address: '1123 E Broad St, Columbus, OH 43205', status: 'not_started', customerStatus: 'Lost', salespersonId: 'sp1', portalLive: false, autoNotifications: false, salesAppointment: '2026-02-12T09:00:00Z', buildType: 'replacement', leadSource: 'phone', statusChangedAt: '2026-02-15T10:00:00Z', lastContacted: '2026-02-15T10:00:00Z', createdAt: '2026-02-10T10:00:00Z' },
  // 9. Quote Expired
  { id: 'proj9', customerId: 'cust9', name: 'Thompson Fence', address: '3456 Morse Rd, Columbus, OH 43231', status: 'not_started', customerStatus: 'Quote Expired', salespersonId: 'sp3', portalLive: false, autoNotifications: false, salesAppointment: '2026-03-15T15:00:00Z', buildType: 'new_build', leadSource: 'webflow_form', statusChangedAt: '2026-03-25T10:00:00Z', lastContacted: '2026-03-20T14:00:00Z', createdAt: '2026-03-15T10:00:00Z' },
  // 9b. Quote Expired - Another
  { id: 'proj9b', customerId: 'cust9b', name: 'Sanchez Fence', address: '2890 Cleveland Ave, Columbus, OH 43224', status: 'not_started', customerStatus: 'Quote Expired', salespersonId: 'sp1', portalLive: false, autoNotifications: false, salesAppointment: '2026-03-22T10:00:00Z', buildType: 'replacement', leadSource: 'google_lsa', statusChangedAt: '2026-04-01T10:00:00Z', lastContacted: '2026-03-28T09:00:00Z', createdAt: '2026-03-20T10:00:00Z' },
  // Needs Qualifying - New web leads
  { id: 'proj_nq1', customerId: 'cust_nq1', name: 'Green Fence', address: '1590 Parsons Ave, Columbus, OH 43207', status: 'not_started', customerStatus: 'Needs Qualifying', salespersonId: 'sp1', portalLive: false, autoNotifications: false, buildType: 'new_build', leadSource: 'webflow_form', statusChangedAt: '2026-04-07T14:00:00Z', lastContacted: '2026-04-07T14:00:00Z', createdAt: '2026-04-07T14:00:00Z' },
  { id: 'proj_nq2', customerId: 'cust_nq2', name: 'Wilson Fence Repair', address: '4521 Karl Rd, Columbus, OH 43224', status: 'not_started', customerStatus: 'Needs Qualifying', salespersonId: 'sp2', portalLive: false, autoNotifications: false, buildType: 'repair', leadSource: 'webflow_form', statusChangedAt: '2026-04-08T09:30:00Z', lastContacted: '2026-04-08T09:30:00Z', createdAt: '2026-04-08T09:30:00Z' },
  { id: 'proj_nq3', customerId: 'cust_nq3', name: 'Davis Pool Fence', address: '789 Livingston Ave, Columbus, OH 43205', status: 'not_started', customerStatus: 'Needs Qualifying', salespersonId: 'sp3', portalLive: false, autoNotifications: false, buildType: 'new_build', leadSource: 'google_lsa', statusChangedAt: '2026-04-08T11:00:00Z', lastContacted: '2026-04-08T11:00:00Z', createdAt: '2026-04-08T11:00:00Z' },
  // 10. Permit Preparation
  { id: 'proj10', customerId: 'cust10', name: 'Brooks Fence', address: '3367 Indianola Ave, Columbus, OH 43214', status: 'permit_preparation', customerStatus: 'Permit Preparation', salespersonId: 'sp1', portalLive: true, autoNotifications: true, salesAppointment: '2026-02-28T10:00:00Z', depositAmount: 2800, depositPaid: true, buildType: 'new_build', leadSource: 'unknown', createdAt: '2026-03-01T10:00:00Z' },
  // 11. Customer Docs Needed
  { id: 'proj11', customerId: 'cust11', name: 'Kowalski Fence', address: '6278 Olentangy River Rd, Columbus, OH 43235', status: 'customer_docs_needed', customerStatus: 'Customer Docs Needed', salespersonId: 'sp2', portalLive: true, autoNotifications: true, salesAppointment: '2026-02-22T14:00:00Z', depositAmount: 1800, depositPaid: true, documentationNeededDescription: 'HOA approval letter required', buildType: 'new_build', leadSource: 'unknown', createdAt: '2026-02-25T10:00:00Z' },
  // 12. Permit Submitted
  { id: 'proj12', customerId: 'cust12', name: 'Williams Fence', address: '901 S High St, Columbus, OH 43206', status: 'permit_submitted', customerStatus: 'Permit Submitted', salespersonId: 'sp1', portalLive: true, autoNotifications: true, salesAppointment: '2026-02-18T11:00:00Z', depositAmount: 3200, depositPaid: true, buildType: 'new_build', leadSource: 'unknown', createdAt: '2026-02-20T10:00:00Z' },
  // 13. Permit Revision Needed
  { id: 'proj13', customerId: 'cust13', name: 'Nguyen Fence', address: '4520 Karl Rd, Columbus, OH 43224', status: 'permit_revision_needed', customerStatus: 'Permit Revision', salespersonId: 'sp3', portalLive: true, autoNotifications: true, salesAppointment: '2026-02-12T16:00:00Z', depositAmount: 2600, depositPaid: true, buildType: 'new_build', leadSource: 'unknown', createdAt: '2026-02-15T10:00:00Z' },
  // 14. Permit Resubmitted
  { id: 'proj14', customerId: 'cust14', name: 'Garcia Fence', address: '2890 N High St, Columbus, OH 43202', status: 'permit_resubmitted', customerStatus: 'Permit Resubmitted', salespersonId: 'sp1', portalLive: true, autoNotifications: true, salesAppointment: '2026-02-08T09:00:00Z', depositAmount: 2900, depositPaid: true, buildType: 'new_build', leadSource: 'unknown', createdAt: '2026-02-10T10:00:00Z' },
  // 15. Ready to Order Materials
  { id: 'proj15', customerId: 'cust15', name: 'Brown Fence', address: '1567 Westerville Rd, Columbus, OH 43224', status: 'ready_to_order_materials', customerStatus: 'Ready to Order', salespersonId: 'sp2', portalLive: true, autoNotifications: true, salesAppointment: '2026-02-03T10:00:00Z', depositAmount: 2200, depositPaid: true, buildType: 'new_build', leadSource: 'unknown', createdAt: '2026-02-05T10:00:00Z' },
  // 16. Materials Ordered
  { id: 'proj16', customerId: 'cust16', name: 'Wilson Fence', address: '4892 Sawmill Rd, Columbus, OH 43235', status: 'materials_ordered', customerStatus: 'Materials Ordered', salespersonId: 'sp1', portalLive: true, autoNotifications: true, salesAppointment: '2026-01-30T14:00:00Z', depositAmount: 3400, depositPaid: true, buildType: 'new_build', leadSource: 'unknown', createdAt: '2026-02-01T10:00:00Z' },
  // 17. Scheduling Installation
  { id: 'proj17', customerId: 'cust17', name: 'Adams Fence', address: '3234 Agler Rd, Columbus, OH 43219', status: 'scheduling_installation', customerStatus: 'Scheduling Install', salespersonId: 'sp3', portalLive: true, autoNotifications: true, salesAppointment: '2026-01-25T11:00:00Z', depositAmount: 1600, depositPaid: true, buildType: 'new_build', leadSource: 'unknown', createdAt: '2026-01-28T10:00:00Z' },
  // 18. Installation Scheduled
  { id: 'proj18', customerId: 'cust18', name: 'Martinez Fence', address: '7821 Refugee Rd, Columbus, OH 43232', status: 'installation_scheduled', customerStatus: 'Install Scheduled', salespersonId: 'sp1', portalLive: true, autoNotifications: true, salesAppointment: '2026-01-22T10:00:00Z', depositAmount: 2500, depositPaid: true, installationDate: '2026-04-08T08:00:00Z', buildType: 'new_build', leadSource: 'unknown', createdAt: '2026-01-25T10:00:00Z' },
  // 19. Installation Delayed
  { id: 'proj19', customerId: 'cust19', name: 'Clark Fence', address: '5678 Georgesville Rd, Columbus, OH 43228', status: 'installation_delayed', customerStatus: 'Install Delayed', salespersonId: 'sp2', portalLive: true, autoNotifications: true, salesAppointment: '2026-01-18T15:00:00Z', depositAmount: 3100, depositPaid: true, installationDate: '2026-03-25T08:00:00Z', buildType: 'new_build', leadSource: 'unknown', createdAt: '2026-01-20T10:00:00Z' },
  // 20. Installation In Progress
  { id: 'proj20', customerId: 'cust20', name: 'Taylor Fence', address: '9012 Hamilton Rd, Columbus, OH 43219', status: 'installation_in_progress', customerStatus: 'Installing', salespersonId: 'sp1', portalLive: true, autoNotifications: true, salesAppointment: '2026-01-12T09:00:00Z', depositAmount: 3600, depositPaid: true, installationDate: '2026-03-30T08:00:00Z', buildType: 'new_build', leadSource: 'unknown', createdAt: '2026-01-15T10:00:00Z' },
  // 21. Scheduling Walkthrough
  { id: 'proj21', customerId: 'cust21', name: 'Scott Fence', address: '2345 Parsons Ave, Columbus, OH 43207', status: 'scheduling_walkthrough', customerStatus: 'Scheduling Walkthrough', salespersonId: 'sp3', portalLive: true, autoNotifications: true, salesAppointment: '2026-01-08T14:00:00Z', depositAmount: 2300, depositPaid: true, installationDate: '2026-03-20T08:00:00Z', buildType: 'new_build', leadSource: 'unknown', createdAt: '2026-01-10T10:00:00Z' },
  // 22. Walkthrough Scheduled
  { id: 'proj22', customerId: 'cust22', name: 'White Fence', address: '6789 Cleveland Ave, Columbus, OH 43231', status: 'walkthrough_scheduled', customerStatus: 'Walkthrough Scheduled', salespersonId: 'sp1', portalLive: true, autoNotifications: true, salesAppointment: '2026-01-03T10:00:00Z', depositAmount: 2700, depositPaid: true, installationDate: '2026-03-15T08:00:00Z', walkthroughDate: '2026-04-05T10:00:00Z', buildType: 'new_build', leadSource: 'unknown', createdAt: '2026-01-05T10:00:00Z' },
  // 23. Fixes Needed
  { id: 'proj23', customerId: 'cust23', name: 'Lee Fence', address: '4321 Livingston Ave, Columbus, OH 43227', status: 'fixes_needed', customerStatus: 'Fixes Needed', salespersonId: 'sp2', portalLive: true, autoNotifications: true, salesAppointment: '2025-12-22T11:00:00Z', depositAmount: 2100, depositPaid: true, installationDate: '2026-03-10T08:00:00Z', walkthroughDate: '2026-03-28T10:00:00Z', buildType: 'new_build', leadSource: 'unknown', createdAt: '2025-12-28T10:00:00Z' },
  // 24. Final Payment Due
  { id: 'proj24', customerId: 'cust24', name: 'Harris Fence', address: '8765 Sunbury Rd, Columbus, OH 43230', status: 'final_payment_due', customerStatus: 'Final Payment Due', salespersonId: 'sp1', portalLive: true, autoNotifications: true, salesAppointment: '2025-12-18T14:00:00Z', depositAmount: 2800, depositPaid: true, installationDate: '2026-03-05T08:00:00Z', walkthroughDate: '2026-03-25T10:00:00Z', finalPaymentAmount: 2800, buildType: 'new_build', leadSource: 'unknown', createdAt: '2025-12-20T10:00:00Z' },
  // 25. Requesting Review
  { id: 'proj25', customerId: 'cust25', name: 'Robinson Fence', address: '1234 Dublin Rd, Columbus, OH 43215', status: 'requesting_review', customerStatus: 'Requesting Review', salespersonId: 'sp3', portalLive: true, autoNotifications: true, salesAppointment: '2025-12-12T09:00:00Z', depositAmount: 1400, depositPaid: true, installationDate: '2026-02-25T08:00:00Z', walkthroughDate: '2026-03-15T10:00:00Z', finalPaymentAmount: 1400, finalPaymentPaid: true, buildType: 'new_build', leadSource: 'unknown', createdAt: '2025-12-15T10:00:00Z' },
  // 26. Complete
...
// Phase colors:
// Permits: Blue (#dbeafe/#1d4ed8)
// Materials: Orange (#fed7aa/#9a3412)
// Scheduling: Purple (#e9d5ff/#6b21a8)
// Installation: Cyan (#ccfbf1/#0f766e)
// Close Out: Green (#d1fae5/#065f46)

export const initialProjectStatusConfigs: ProjectStatusConfig[] = [
  // Permits Phase (Post-sale starts here) - Blue
  { id: 'status1', name: 'Not Started', customerLabel: 'Getting Started', phase: 'permits', triggerNote: 'Project won, not yet started', sortOrder: 1, bgColor: '#dbeafe', textColor: '#1d4ed8', isActive: true, notifications: { slack: { enabled: true, channel: '#fb-ops' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'status2', name: 'Permit Preparation', customerLabel: 'Processing Permits', phase: 'permits', triggerNote: 'Preparing permit application', sortOrder: 2, bgColor: '#dbeafe', textColor: '#1d4ed8', isActive: true, notifications: { slack: { enabled: true, channel: '#fb-ops' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'status3', name: 'Customer Docs Needed', customerLabel: 'Documents Required', phase: 'permits', triggerNote: 'Waiting on customer documents', sortOrder: 3, bgColor: '#dbeafe', textColor: '#1d4ed8', isActive: true, notifications: { slack: { enabled: false, channel: '' }, sms: { enabled: true, template: 'Hi {{customer_name}}, we need some documents from you to proceed.' }, email: { enabled: true, subject: 'Documents Needed', body: 'Hi {{customer_name}},\n\nWe need some documents to proceed with your permit.' } } },
  { id: 'status4', name: 'Permit Submitted', customerLabel: 'Processing Permits', phase: 'permits', triggerNote: 'Permit submitted to city', sortOrder: 4, bgColor: '#dbeafe', textColor: '#1d4ed8', isActive: true, notifications: { slack: { enabled: true, channel: '#fb-ops' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'status5', name: 'Permit Revision Needed', customerLabel: 'Processing Permits', phase: 'permits', triggerNote: 'City requested changes', sortOrder: 5, bgColor: '#fee2e2', textColor: '#991b1b', isActive: true, notifications: { slack: { enabled: true, channel: '#fb-ops' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'status6', name: 'Permit Resubmitted', customerLabel: 'Processing Permits', phase: 'permits', triggerNote: 'Revised permit resubmitted', sortOrder: 6, bgColor: '#dbeafe', textColor: '#1d4ed8', isActive: true, notifications: { slack: { enabled: false, channel: '' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  // Materials Phase - Orange
  ...
  { id: 'status11', name: 'Installation Delayed', customerLabel: 'Installation Rescheduling', phase: 'scheduling', triggerNote: 'Install postponed', sortOrder: 11, bgColor: '#e9d5ff', textColor: '#6b21a8', isActive: true, notifications: { slack: { enabled: true, channel: '#fb-ops' }, sms: { enabled: true, template: 'Hi {{customer_name}}, we need to reschedule your installation.' }, email: { enabled: false, subject: '', body: '' } } },
  // Installation Phase - Cyan
  { id: 'status12', name: 'Installation in Progress', customerLabel: 'Installation in Progress', phase: 'installation', triggerNote: 'Crew on site', sortOrder: 12, bgColor: '#ccfbf1', textColor: '#0f766e', isActive: true, notifications: { slack: { enabled: true, channel: '#fb-ops' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'status13', name: 'Scheduling Walkthrough', customerLabel: 'Scheduling Final Walkthrough', phase: 'installation', triggerNote: 'Install complete, scheduling walkthrough', sortOrder: 13, bgColor: '#ccfbf1', textColor: '#0f766e', isActive: true, notifications: { slack: { enabled: false, channel: '' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'status14', name: 'Walkthrough Scheduled', customerLabel: 'Walkthrough Scheduled', phase: 'installation', triggerNote: 'Walkthrough date set', sortOrder: 14, bgColor: '#ccfbf1', textColor: '#0f766e', isActive: true, notifications: { slack: { enabled: false, channel: '' }, sms: { enabled: true, template: 'Hi {{customer_name}}, your walkthrough is scheduled!' }, email: { enabled: false, subject: '', body: '' } } },
  // Close Out Phase - Green
  { id: 'status15', name: 'Fixes Needed', customerLabel: 'Completing Final Details', phase: 'close_out', triggerNote: 'Punch list items identified', sortOrder: 15, bgColor: '#fee2e2', textColor: '#991b1b', isActive: true, notifications: { slack: { enabled: true, channel: '#fb-ops' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'status16', name: 'Final Payment Due', customerLabel: 'Final Payment Due', phase: 'close_out', triggerNote: 'Ready for final payment', sortOrder: 16, bgColor: '#d1fae5', textColor: '#065f46', isActive: true, notifications: { slack: { enabled: false, channel: '' }, sms: { enabled: true, template: 'Hi {{customer_name}}, your fence is complete! Final payment is now due.' }, email: { enabled: true, subject: 'Final Payment Due', body: 'Hi {{customer_name}},\n\nYour fence installation is complete. Please submit your final payment.' } } },
  { id: 'status17', name: 'Requesting Review', customerLabel: 'Thank You!', phase: 'close_out', triggerNote: 'Asking for Google review', sortOrder: 17, bgColor: '#d1fae5', textColor: '#065f46', isActive: true, notifications: { slack: { enabled: false, channel: '' }, sms: { enabled: true, template: 'Hi {{customer_name}}, thank you for choosing Fence Boys! Would you mind leaving us a review?' }, email: { enabled: false, subject: '', body: '' } } },
...
export const initialCustomerStatusConfigs: CustomerStatusConfig[] = [
  { id: 'cstat0', name: 'Needs Qualifying', customerLabel: 'We Will Be In Touch', triggerNote: 'New request needs qualifying', sortOrder: 0, bgColor: '#f3f4f6', textColor: '#374151', isActive: true, hasPortalPage: false, notifications: { slack: { enabled: true, channel: '#fb-sales' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'cstat1', name: 'New Lead', customerLabel: 'Schedule Your Consultation', triggerNote: 'New lead created', sortOrder: 1, bgColor: '#f3f4f6', textColor: '#374151', isActive: true, hasPortalPage: false, notifications: { slack: { enabled: true, channel: '#fb-sales' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'cstat2', name: 'Contact Attempted', customerLabel: 'We\'re Trying to Reach You', triggerNote: 'Attempted to contact customer', sortOrder: 2, bgColor: '#fef3c7', textColor: '#92400e', isActive: true, hasPortalPage: false, notifications: { slack: { enabled: false, channel: '' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'cstat3', name: 'Contacted', customerLabel: 'Schedule Your Consultation', triggerNote: 'Successfully contacted customer', sortOrder: 3, bgColor: '#dbeafe', textColor: '#1d4ed8', isActive: true, hasPortalPage: true, notifications: { slack: { enabled: false, channel: '' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'cstat4', name: 'Quote Scheduled', customerLabel: 'Quote Visit Scheduled', triggerNote: 'Quote appointment booked', sortOrder: 4, bgColor: '#dbeafe', textColor: '#1d4ed8', isActive: true, hasPortalPage: true, notifications: { slack: { enabled: true, channel: '#fb-sales' }, sms: { enabled: true, template: 'Hi {{customer_name}}, your quote appointment is confirmed!' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'cstat5', name: 'Building Proposal', customerLabel: 'Preparing Your Quote', triggerNote: 'Salesperson building proposal', sortOrder: 5, bgColor: '#dbeafe', textColor: '#1d4ed8', isActive: true, hasPortalPage: true, notifications: { slack: { enabled: false, channel: '' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'cstat6', name: 'Proposal Sent', customerLabel: 'Review Your Proposal', triggerNote: 'Proposal sent to customer', sortOrder: 6, bgColor: '#d1fae5', textColor: '#065f46', isActive: true, hasPortalPage: true, notifications: { slack: { enabled: true, channel: '#fb-sales' }, sms: { enabled: true, template: 'Hi {{customer_name}}, your proposal is ready!' }, email: { enabled: true, subject: 'Your Fence Boys Proposal', body: 'Hi {{customer_name}},\n\nYour proposal is ready for review.' } } },
  { id: 'cstat7', name: 'Awaiting Deposit', customerLabel: 'Pay Deposit to Begin', triggerNote: 'Waiting for customer deposit', sortOrder: 7, bgColor: '#d1fae5', textColor: '#065f46', isActive: true, hasPortalPage: true, notifications: { slack: { enabled: false, channel: '' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'cstat8', name: 'Quote Expired', customerLabel: 'Quote Expired', triggerNote: 'Proposal expired without response', sortOrder: 8, bgColor: '#fee2e2', textColor: '#991b1b', isActive: true, hasPortalPage: true, notifications: { slack: { enabled: true, channel: '#fb-sales' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'cstat9', name: 'Active Project', customerLabel: 'Welcome to Fence Boys!', triggerNote: 'Deal won - deposit received', sortOrder: 9, bgColor: '#d1fae5', textColor: '#065f46', isActive: true, hasPortalPage: false, notifications: { slack: { enabled: true, channel: '#fb-sales' }, sms: { enabled: true, template: 'Welcome to the Fence Boys family, {{customer_name}}!' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'cstat10', name: 'Complete', customerLabel: 'Project Complete!', triggerNote: 'Project finished', sortOrder: 10, bgColor: '#d1fae5', textColor: '#065f46', isActive: true, hasPortalPage: false, notifications: { slack: { enabled: true, channel: '#fb-sales' }, sms: { enabled: true, template: 'Thank you for choosing Fence Boys, {{customer_name}}! Enjoy your new fence!' }, email: { enabled: false, subject: '', body: '' } } },
  { id: 'cstat11', name: 'Lost', customerLabel: 'Project Closed', triggerNote: 'Deal lost', sortOrder: 11, bgColor: '#fee2e2', textColor: '#991b1b', isActive: true, hasPortalPage: true, notifications: { slack: { enabled: true, channel: '#fb-sales' }, sms: { enabled: false, template: '' }, email: { enabled: false, subject: '', body: '' } } },
];
